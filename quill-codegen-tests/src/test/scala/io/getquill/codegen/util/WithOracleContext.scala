...
object WithOracleContextStandalone extends WithContextAux with WithOracleContext
...
trait WithOracleContext extends WithContextAux {
  ...
  implicit def oracleContextForTest2: Aux[
    TheDB,
  ...
  implicit def oracleContextForTest3: Aux[
    TheDB,
  ...
  implicit def oracleContextForTest4: Aux[
    TheDB,
  ...
  implicit def oracleContextForTest5: Aux[
    TheDB,
